...
const { PRIVATE_4, CONTRACT_ADDRESS_BNBTESTNET, CONTRACT_ADDRESS_GOERLI } = process.env;
...
const signerGoerli = new ethers.Wallet(PRIVATE_4, providerGoerli);
...
const signerBNBTestnet = new ethers.Wallet(PRIVATE_4, providerBNBTestnet);
