...
const { PRIVATE_7, CONTRACT_ADDRESS_BNBTESTNET, CONTRACT_ADDRESS_GOERLI } = process.env;
...
const signerGoerli = new ethers.Wallet(PRIVATE_7, providerGoerli);
...
const signerBNBTestnet = new ethers.Wallet(PRIVATE_7, providerBNBTestnet);
