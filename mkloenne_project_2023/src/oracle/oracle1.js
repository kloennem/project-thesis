...
const { PRIVATE_1, CONTRACT_ADDRESS_BNBTESTNET, CONTRACT_ADDRESS_GOERLI } = process.env;
...
const signerGoerli = new ethers.Wallet(PRIVATE_1, providerGoerli);
...
const signerBNBTestnet = new ethers.Wallet(PRIVATE_1, providerBNBTestnet);
