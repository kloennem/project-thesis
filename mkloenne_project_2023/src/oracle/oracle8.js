...
const { PRIVATE_8, CONTRACT_ADDRESS_BNBTESTNET, CONTRACT_ADDRESS_GOERLI } = process.env;
...
const signerGoerli = new ethers.Wallet(PRIVATE_8, providerGoerli);
...
const signerBNBTestnet = new ethers.Wallet(PRIVATE_8, providerBNBTestnet);
