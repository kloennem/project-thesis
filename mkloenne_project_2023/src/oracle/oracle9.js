...
const { PRIVATE_9, CONTRACT_ADDRESS_BNBTESTNET, CONTRACT_ADDRESS_GOERLI } = process.env;
...
const signerGoerli = new ethers.Wallet(PRIVATE_9, providerGoerli);
...
const signerBNBTestnet = new ethers.Wallet(PRIVATE_9, providerBNBTestnet);
