...
const { PRIVATE_5, CONTRACT_ADDRESS_BNBTESTNET, CONTRACT_ADDRESS_GOERLI } = process.env;
...
const signerGoerli = new ethers.Wallet(PRIVATE_5, providerGoerli);
...
const signerBNBTestnet = new ethers.Wallet(PRIVATE_5, providerBNBTestnet);
