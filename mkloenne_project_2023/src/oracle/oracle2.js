...
const { PRIVATE_2, CONTRACT_ADDRESS_BNBTESTNET, CONTRACT_ADDRESS_GOERLI } = process.env;
...
const signerGoerli = new ethers.Wallet(PRIVATE_2, providerGoerli);
...
const signerBNBTestnet = new ethers.Wallet(PRIVATE_2, providerBNBTestnet);
