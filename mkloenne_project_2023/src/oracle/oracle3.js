...
const { PRIVATE_3, CONTRACT_ADDRESS_BNBTESTNET, CONTRACT_ADDRESS_GOERLI } = process.env;
...
const signerGoerli = new ethers.Wallet(PRIVATE_3, providerGoerli);
...
const signerBNBTestnet = new ethers.Wallet(PRIVATE_3, providerBNBTestnet);
